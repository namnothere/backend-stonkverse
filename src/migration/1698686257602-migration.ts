...
export class Migration1698686257602 implements MigrationInterface {
  name = 'Migration1698686257602';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user"."historical_data" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "Date" TIMESTAMP WITH TIME ZONE NOT NULL, "OpenPrice" bigint NOT NULL, "HighPrice" bigint NOT NULL, "LowPrice" bigint NOT NULL, "ClosePrice" bigint NOT NULL, "AdjClosePrice" bigint NOT NULL, "Volume" bigint NOT NULL, "Symbol" text, "Change" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d6303a200d1d9dc8f3bcb857331" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
